...
func (h *Handler) handlePutDelta(key string, delta *kvrwset.DeltaDescriptor, channelID string, txid string) error {
	payloadBytes := marshalOrPanic(&pb.PutState{Key: key, Delta: delta})
